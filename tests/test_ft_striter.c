...
int main_test_ft_striter()
	{//ft_striter
		...
		INFO(SHOW_STRING("before ", ft_stirter_upper_txtaz123HAHZ));
		ft_striter(ft_stirter_upper_txtaz123HAHZ, &strtter_func_upper);
		INFO(SHOW_STRING("after  ", ft_stirter_upper_txtaz123HAHZ));
		FAIL_IF_NOT(ft_strequ(ft_stirter_upper_txtaz123HAHZ, "TXTAZ123HAHZ"));

		INFO(SHOW_STRING("before ", ft_stirter_lower_txtaz123HAHZ));
		ft_striter(ft_stirter_lower_txtaz123HAHZ, &strtter_func_lower);
		INFO(SHOW_STRING("after  ", ft_stirter_lower_txtaz123HAHZ));
